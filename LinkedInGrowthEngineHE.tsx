...
const resultsData = {
  h2: "תוצאות אמיתיות",
  sub: "מספרים, לא הבטחות.",
  note: "כל מספר כאן הוא אורגני.",
  items: [
    ...
    { num: "~5,000", label: "עוקבים עסקיים, צמיחה אורגנית מלאה. אפס הוצאה על פרסום ממומן." },
  ],
}
  ...
  return (
    <section style={{ background: CREAM, padding: "80px 32px", fontFamily: FONT }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        <Reveal delay={400}><p style={{ fontSize: 13, color: MUTED, marginTop: 20, textAlign: "right" }}>{resultsData.note}</p></Reveal>
      </div>
    </section>
  )
}
