...
/**
 * OctaLoom — Footer EN (standalone Framer code component)
 * ───────────────────────────────────────────────────────
 * English pages — LTR, slugs without -he.
 ...
 * Ported from octaloom-nav-footer.jsx (SiteFooter) into Framer .tsx format.
 * 3 dead links fixed: LinkedIn for Organizations, Workshops, Contact now
 * point to real pages (matching the EN navbar). No other changes.
 */
...
function Footer() {
  ...
  return (
    <footer style={{
      ...
      background: NAVY, color: "rgba(255,255,255,0.7)", direction: "ltr", fontFamily: FONT,
    }}>
