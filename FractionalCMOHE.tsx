            ...
            <div className={"orgchart" + (collapsed ? " collapse" : "")}>
              ...
              <div className="orgchart__node">
                <div className="orgchart__avatar">
                  <img src="https://raw.githubusercontent.com/Hanita-y/Octaloom-images-and-videos/main/Headshot-1.png" alt="חניתה יודובסקי, סמנכ״לית שיווק במיקור חוץ ומייסדת OctaLoom" onError={(e: any) => { e.target.style.display = "none"; e.target.parentNode.textContent = "HY" }} />
                </div>
