...
const T = {
  ...
  step2Sub:     "You can choose more than one",
  ...
  notesLabel:     "Add anything important (optional)",
  next:           "Next",
  back:           "Back",
  send:           "Send",
  sending:        "Sending...",
  successTitle:   "Got it.",
  successSub:     "Now book a short call:",
  bookBtn:        "Book a Call Now",
  trustLine:      "Just a call. If there's a fit, we continue.",
  ...
  altContact:     "Prefer direct contact?",
...
function NavEN() {
  ...
  return (
    <nav dir="ltr" style={{
      ...
      {!isMobile && (
        <div style={{ display: "flex", alignItems: "center", gap: 28, direction: "ltr" }}>
          {desktopDropdown}
          {navLinks.map((item, i) => (
      ...
      <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
        <a href="/contact-he" style={{ fontSize: 13, fontWeight: 700, color: linkColor, fontFamily: FF, textDecoration: "none", padding: "5px 10px" }}>&#1506;&#1489;</a>
        {isMobile && hamburger}
      </div>
...
function FooterEN() {
  ...
  return (
    <footer dir="ltr" style={{ padding: "64px 0 0", background: "#201b4e", color: "rgba(255,255,255,0.7)", fontFamily: FF }}>
...
export default function ContactPageEN() {
    ...
    try {
      const res = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          from_name: "OctaLoom Contact Page EN",
  ...
  const inputStyle: React.CSSProperties = {
    ...
    outline: "none", boxSizing: "border-box" as const, direction: "ltr",
  ...
  const labelStyle: React.CSSProperties = {
    ...
    marginBottom: 7, display: "block", fontFamily: FF, textAlign: "left",
  }
  ...
  return (
    <div style={{ width: "100vw", overflowX: "hidden", background: C.cream, minHeight: "100vh" }}>
      ...
      <section style={{ position: "relative", paddingTop: isMobile ? 120 : 160, paddingBottom: isMobile ? 64 : 96, background: C.cream, overflow: "hidden" }}>
        <div style={{
          position: "absolute", top: isMobile ? -80 : -120, right: isMobile ? -80 : -60,
        ...
        <Container>
          <div style={{ display: "flex", justifyContent: "center" }}>
            <div style={{ width: "100%", maxWidth: 660 }}>
              <motion.div
                    ...
                    {[1,2,3].map((s, i) => (
                      <React.Fragment key={s}>
                        <div style={{
                          ...
                          <span style={{ fontSize: 13, fontWeight: 700, color: step >= s ? "white" : C.textDim, fontFamily: FF }}>{s}</span>
                        </div>
                ...
                {status === "success" && (
                  <motion.div initial={{ opacity: 0, scale: 0.94 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.4 }}
                    style={{ textAlign: "center", padding: isMobile ? "20px 0" : "32px 0", direction: "ltr" }}>
                    ...
                    <h2 style={{ fontFamily: FF, fontWeight: 700, fontSize: isMobile ? 24 : 28, color: C.deepPurple, margin: "0 0 10px" }}>{T.successTitle}</h2>
                ...
                <AnimatePresence mode="wait">
                  ...
                  {status !== "success" && step === 1 && (
                    <motion.div key="s1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.25 }}
                      style={{ direction: "ltr" }}>
                      <h2 style={{ fontFamily: FF, fontWeight: 700, fontSize: isMobile ? 21 : 24, color: C.deepPurple, margin: "0 0 22px" }}>{T.step1Title}</h2>
                  ...
                  {status !== "success" && step === 2 && (
                    <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.25 }}
                      style={{ direction: "ltr" }}>
                      <h2 style={{ fontFamily: FF, fontWeight: 700, fontSize: isMobile ? 21 : 24, color: C.deepPurple, margin: "0 0 4px" }}>{T.step2Title}</h2>
                  ...
                  {status !== "success" && step === 3 && (
                    <motion.div key="s3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0 }} transition={{ duration: 0.25 }}
                      style={{ direction: "ltr" }}>
                      <h2 style={{ fontFamily: FF, fontWeight: 700, fontSize: isMobile ? 21 : 24, color: C.deepPurple, margin: "0 0 22px" }}>{T.step3Title}</h2>
              ...
              {/* Alt contact */}
              <div style={{ marginTop: 48, textAlign: "center", direction: "ltr" }}>
