...
.aith-btn--lime{background:var(--lime);color:var(--ink)}
...
.aith-appwin__list li b{color:var(--cream);font-weight:700}
...
.aith-endzone{position:relative}
...
@media (max-width:1199px) and (min-width:768px){.aith-apps__grid{grid-template-columns:1fr;gap:22px}.aith-built__grid{grid-template-columns:1fr}.aith-how__pipe{grid-template-columns:1fr 1fr 1fr}.aith-explain__body{grid-template-columns:1fr 1fr}.aith-intro__text{font-size:20px}}
@media (max-width:540px){.aith-btn{padding:14px 22px;font-size:14px}.aith-section{padding:72px 0}.aith-hero__cta-row .aith-btn{width:100%;justify-content:center}.aith-final__cta .aith-btn{width:100%;justify-content:center}.aith-quote__who{flex-wrap:wrap}}
    ...
    <header className="aith-hero">
      <div className="aith-container aith-hero__inner">
        ...
        <div className="aith-hero__grid">
          ...
          <div className="aith-rv aith-rv--left" style={{ transitionDelay: ".3s" }}>
        ...
        <div className="aith-apps__grid">
            ...
            more={
              <>
                ...
                <ul className="aith-appwin__list">
                  ...
                  <li>{"\u05d7\u05d5\u05d5\u05d9\u05d5\u05ea "}<L>onboarding</L>{" \u05dc\u05dc\u05e7\u05d5\u05d7\u05d5\u05ea \u05d7\u05d3\u05e9\u05d9\u05dd \u05e9\u05de\u05e8\u05d2\u05d9\u05e9\u05d9\u05dd \u05e9\u05d8\u05d9\u05e4\u05dc\u05d5 \u05d1\u05d4\u05dd"}</li>
                </ul>
              </>
            }
          />
          ...
          <AppWindow
            ...
            more={
              <>
                <ul className="aith-appwin__list">
                  <li>{"\u05d0\u05d5\u05d8\u05d5\u05de\u05e6\u05d9\u05d9\u05ea \u05e8\u05e6\u05e4\u05d9 \u05de\u05d9\u05d9\u05dc\u05d9\u05dd \u05e2\u05dd \u05e4\u05e8\u05e1\u05d5\u05e0\u05dc\u05d9\u05d6\u05e6\u05d9\u05d4 \u05e9\u05e0\u05d5\u05e6\u05e8\u05ea \u05d1-"}<L>AI</L></li>
                  <li>{"\u05de\u05d7\u05d6\u05d5\u05e8 \u05ea\u05d5\u05db\u05df: \u05ea\u05d5\u05db\u05df \u05d0\u05d7\u05d3, \u05e4\u05d5\u05e8\u05de\u05d8\u05d9\u05dd \u05de\u05e8\u05d5\u05d1\u05d9\u05dd, \u05d4\u05e4\u05e6\u05d4 \u05d0\u05d5\u05d8\u05d5\u05de\u05d8\u05d9\u05ea"}</li>
                  <li>{"\u05e0\u05d9\u05ea\u05d5\u05d1 \u05d5\u05d3\u05d9\u05e8\u05d5\u05d2 \u05dc\u05d9\u05d3\u05d9\u05dd"}</li>
                  <li>{"\u05ea\u05d6\u05de\u05d5\u05df \u05e4\u05e8\u05e1\u05d5\u05de\u05d9\u05dd \u05e2\u05dd \u05ea\u05d6\u05de\u05d5\u05df \u05de\u05d5\u05ea\u05d0\u05dd "}<L>AI</L></li>
                </ul>
                <div className="aith-appwin__callout">
