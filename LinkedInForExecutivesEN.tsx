...
.exec-hero__h1{font-size:clamp(32px,5vw,52px);font-weight:700;line-height:1.1;letter-spacing:-0.025em;color:white;max-width:720px;margin-bottom:24px;font-family:var(--font-en)}
...
.pull-quote p{font-size:20px;font-weight:700;line-height:1.5;color:var(--deep-purple);letter-spacing:-0.01em;font-family:var(--font-en)}
...
.timeline__title{font-size:22px;font-weight:700;color:var(--deep-purple);margin-bottom:12px;font-family:var(--font-en)}
...
.fit-card h3{font-size:18px;font-weight:700;color:white;margin-bottom:20px;font-family:var(--font-en)}
...
.score-card{text-align:center;max-width:600px;margin:0 auto;font-family:var(--font-en)}
...
.about__p{font-size:16px;line-height:1.7;color:var(--deep-purple);opacity:0.7;margin-bottom:14px;font-family:var(--font-en)}
...
.faq__q h3{font-size:17px;font-weight:700;color:var(--deep-purple);font-family:var(--font-en)}
...
.faq__a p{font-size:15px;color:var(--deep-purple);line-height:1.65;opacity:0.65;font-family:var(--font-en)}
.bottom-cta{color:var(--deep-purple);text-align:center}
.cta__title{font-size:clamp(28px,4.5vw,48px);line-height:1.12;color:var(--deep-purple);margin-bottom:16px;font-weight:700;font-family:var(--font-en)}
...
// ─── Content (EX object — EN locked) ────────────────────────────────────────
const EX = {
  hero: {
    h1: { en: 'LinkedIn Ghostwriting & Thought Leadership for B2B Founders', he: '' },
    sub: { en: "You know LinkedIn matters. You also know the last three weeks you posted something, then stopped, then meant to restart, then a Series A call ran long and suddenly it's Thursday again. Meanwhile, the founder of the competitor you actually respect is showing up every week, compounding trust, and probably ending up in front of the same buyers you were hoping to reach.", he: '' },
    cta: { en: 'Book a Free Discovery Call', he: '' },
  },
  entity: {
    en: "OctaLoom runs LinkedIn as a full marketing system for B2B SaaS founders and SMB owners. Founder-led content, company page management, thought leadership positioning, and inbound lead generation, all delivered by one operator moving at AI speed. I'm Hanita Yudovski, a LinkedIn-led Fractional CMO and host of the What's the Story With? B2B marketing podcast.",
    he: "",
  },
  problem: {
    title: { en: "The Real Problem (And Why It's Not \"You Should Post More\")", he: '' },
    content: {
      en: [
        "Everyone tells you to post more. That's not the problem.",
        "The problem is that posting without a system doesn't compound. Hiring an in-house marketer means 2-3 months of onboarding plus a full-time salary before you see any output. Hiring an agency means account managers, kick-off calls, and a junior writer learning your industry on your budget. Doing it yourself means it falls off the calendar the moment your next sales call runs long, which is always.",
        "You don't need more posts. You need a LinkedIn system that runs whether you're in it or not. That's what this page is about.",
      ],
      he: [],
    },
    alternatives: {
      en: [
        { label: 'Hire in-house', desc: '2-3 months onboarding + full-time salary before any output' },
        { label: 'Hire an agency', desc: 'Account managers, kick-off calls, junior writer learning your industry on your budget' },
        { label: 'Do it yourself', desc: 'Falls off the calendar the moment your next sales call runs long' },
      ],
    },
    pullquote: { en: "You don't need more posts. You need a LinkedIn system that runs whether you're in it or not.", he: '' },
  },
  timeline: {
    title: { en: 'What This Actually Looks Like', he: '' },
    sub: { en: "Here's the honest arc of a founder engagement.", he: '' },
    months: [
      {
        label: { en: 'Month 1', he: '' },
        title: { en: 'Onboarding and calibration', he: '' },
        items: {
          en: [
            'Deep audience research (who actually buys from you, what matters to them, what signals trust)',
            'Competitive scan of other founders in your space',
            'Voice and positioning work with you directly, usually 2-3 short sessions',
            'KPIs and measurement setup',
            'Content starts shipping by week three',
          ],
          he: [],
        },
        time: { en: 'About 30 minutes per week from you', he: '' },
      },
      {
        label: { en: 'Months 2-3', he: '' },
        title: { en: 'System lock', he: '' },
        items: {
          en: [
            '2-3 posts per week on your personal profile',
            'Company page content, tied to founder content',
            'Active engagement: comments, DMs, network building',
            'Monthly strategic review at end of each month',
          ],
          he: [],
        },
        time: { en: 'About 15 minutes per week. Voice is locked, workflow is tight.', he: '' },
      },
      {
        label: { en: 'Month 4+', he: '' },
        title: { en: 'Maintenance mode', he: '' },
        items: {
          en: [
            'System is running, audience is compounding',
            "You're getting DMs from buyers who already feel like they know you",
          ],
          he: [],
        },
        time: { en: 'A monthly check-in of 15-30 minutes. Some months, nothing.', he: '' },
      },
    ],
    pullquote: { en: "The trajectory is always toward less of your time, not more. That's the whole point.", he: '' },
  },
  fit: {
    title: { en: 'Who This Is For', he: '' },
    forYou: {
      title: { en: 'This is for you if:', he: '' },
      items: {
        en: [
          "You're a B2B SaaS founder or SMB owner, usually 10-100 employees",
          'Your buyers (customers, investors, talent) are on LinkedIn',
          'You want your personal profile to drive pipeline',
          "You don't have time to post consistently yourself",
          "You want a strategic partner, not a content vendor",
        ],
        he: [],
      },
    },
    notForYou: {
      title: { en: 'This is not for you if:', he: '' },
      items: {
        en: [
          'You want to hand someone a credit card and disappear',
          "You're in a pure B2C category where LinkedIn isn't where buyers decide",
          'You want daily posts (2-3 strategic posts beat daily noise)',
          'You want guaranteed lead numbers (anyone who promises that is lying)',
        ],
        he: [],
      },
    },
    honesty: { en: "Honesty is the trust signal. If any of the \"not for you\" bullets sound like you, we're not the right fit, and we'll both save time finding that out on the discovery call.", he: '' },
  },
  included: {
    title: { en: "What's Included", he: '' },
    items: {
      en: [
        'Audience and competitive research',
        'Voice and positioning setup (2-3 sessions, once, upfront)',
        'Content strategy tied to your pipeline and business cycles',
        'Ghostwritten posts, 2-3 per week, in your voice',
        'Company page management, tied to founder content',
        'Profile optimization (your LinkedIn as a landing page)',
        'Active engagement strategy (comments, DMs, network building)',
        'Analytics and monthly strategic review',
        'Vibe Marketing delivery (AI-powered, 5-person output)',
      ],
      he: [],
    },
  },
  notIncluded: {
    title: { en: "What's Not Included (Honest)", he: '' },
    items: {
      en: [
        'Paid ads (separate scope)',
        'Other social platforms (LinkedIn specialization on purpose)',
        'Sales closing (we generate leads, you close them)',
        'Daily posts (cadence over frequency)',
        'Ghostwriting for multiple people on same retainer',
        'Guaranteed pipeline numbers',
      ],
      he: [],
    },
  },
  results: {
    title: { en: 'Real Results', he: '' },
    sub: { en: 'Every number below is organic. No paid amplification. No follower buys. Just the system running.', he: '' },
    items: [
      { num: '300%', label: { en: "engagement lift on a B2B SaaS founder's personal brand", he: '' } },
      { num: '770K+', label: { en: 'organic impressions across client LinkedIn accounts', he: '' } },
      { num: '~5,000', label: { en: 'engaged B2B followers grown 100% organically', he: '' } },
    ],
    note: { en: '', he: '' },
  },
  testimonial: {
    quote: {
      en: "I worked directly with Hanita on B2B marketing strategy and LinkedIn execution. The process was thorough and structured: deep competitive research, long-term strategy, and a clear execution plan. The marketing output contributed meaningfully to our global operations.",
      he: '',
    },
    author: { en: 'Yoram Avigad', he: '' },
    role: { en: 'CEO, Totzeret HaNegev', he: '' },
  ...
  about: {
    title: { en: "Hi, I'm Hanita", he: '' },
    text: {
      en: [
        "Hi, I'm Hanita. I'm a LinkedIn-led Fractional CMO, and I build marketing systems for B2B SaaS founders, SMB owners, and solopreneurs who know they need a real marketing department but can't justify (or don't want) hiring one.",
        "My approach: weave strategy, content, automation, and AI into a single working system, the kind that usually takes five specialists, and deliver it as one operator moving at AI speed.",
        "The number I'm most quietly proud of: close to 5,000 engaged B2B followers grown 100% organically, zero ad spend, on my own LinkedIn profile. Everything you see on this page is a system I run on myself first, which is why I can promise what I promise.",
    ...
    cta1: { en: 'Connect on LinkedIn', he: '' },
    cta2: { en: 'Listen to the podcast', he: '' },
  },
  faq: {
    title: { en: 'Frequently Asked Questions', he: '' },
    items: [
      {
        q: { en: 'How is this different from me just posting myself?', he: '' },
        a: { en: "You're a founder, not a marketer. Posting yourself means 45 minutes per post, inconsistent output, no strategy, no measurement, and eventually burnout or guilt. OctaLoom removes the time cost and adds the strategic layer so what gets posted actually compounds into pipeline instead of disappearing into the scroll.", he: '' },
      },
      {
        q: { en: 'How much of my own time does this cost me?', he: '' },
        a: { en: "Upfront: 2-3 hours in the first two weeks for voice and positioning work. Month 1: about 30 minutes per week while we're calibrating. Months 2 and 3: about 15 minutes per week. Month 4 and beyond: typically a monthly 15-30 minute check-in, sometimes nothing. The trajectory is always toward less of your time, not more.", he: '' },
      },
      {
        q: { en: 'Can you actually write in my voice without it sounding generic?', he: '' },
        a: { en: "Yes, and this is the whole reason the onboarding is front-loaded. The first two weeks are about studying how you actually talk, what you actually believe, what you refuse to say. The first month's posts go through you for edits. By month two, the voice is locked. By month four, most clients say their ghostwritten posts sound more like them than the ones they used to write themselves.", he: '' },
      },
      {
        q: { en: 'How long until this starts generating inbound leads?', he: '' },
        a: { en: "Honest timeline: 30 days for engagement lift. 90 days for meaningful inbound traffic. 6 months for measurable pipeline impact. Anyone promising faster is either lying or running ads and calling it \"organic growth.\"", he: '' },
      },
      {
        q: { en: 'Do you work with company pages or just personal profiles?', he: '' },
        a: { en: "Both, and always together. Most B2B wins come from founder-led content on the personal profile, backed by a strong company page that reinforces the story. We build the system across both so they amplify each other.", he: '' },
      },
      {
        q: { en: 'What happens if we part ways?', he: '' },
        a: { en: "You own the voice document, the content calendar structure, the audience research, and the positioning work. If the business changes and you want to bring it in-house, you can. No lock-in theatrics.", he: '' },
      },
      {
        q: { en: 'What if I already have a social media manager?', he: '' },
        a: { en: "Great. This isn't a replacement for them, it's a strategic layer above them. OctaLoom handles founder-led content and the CMO-level thinking. Your social media manager handles execution on the platforms they specialize in.", he: '' },
        enOnly: true,
      },
    ],
  },
  cta: {
    title: { en: 'Ready to Build Your LinkedIn Engine?', he: '' },
    sub: { en: 'No deck. No pitch. No hourly retainer. Just a real conversation about whether OctaLoom can actually move the needle for you.', he: '' },
    cta1: { en: 'Book a Free Discovery Call', he: '' },
    note: { en: "(Discovery calls are strategic conversations, not sales pitches. If it's not a fit, I'll tell you.)", he: '' },
  },
  linkedinScore: {
    title: { en: 'Want to know where you stand?', he: '' },
    stat: { en: "75% of B2B buyers check the CEO's and company's\nLinkedIn profile before making a purchase.", he: '' },
    desc: { en: 'Before we start working together, it helps to know our starting point. Check your LinkedIn presence score for free: 3 minutes, 6 categories, instant results with insights specific to your profile.', he: '' },
    cta: { en: 'Check My Score', he: '' },
  },
}
...
function HPNav() {
  ...
  const dropItemStyle: any = {
    ...
    direction: "ltr", textAlign: "left", fontFamily,
  }
    ...
    <nav style={isMobile && menuOpen
      ...
      {isMobile && menuOpen && (
        <div style={{ flex: 1, display: "flex", flexDirection: "column", padding: "20px 32px 40px", gap: 0, direction: dir }}>
          <p style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--purple)", margin: "0 0 4px", fontFamily }}>Services</p>
          <button onClick={() => setLinkedinExpanded(prev => !prev)}
            style={{ display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: 20, color: "var(--deep-purple)", padding: "11px 0", fontWeight: 600, borderBottom: "1px solid rgba(113,46,172,0.08)", fontFamily, background: "none", border: "none", cursor: "pointer", width: "100%", textAlign: "left" as const }}>
...
function HPFooter() {
  ...
  const headStyle: any = { fontSize: 13, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase", color: "var(--cream)", margin: "0 0 14px", fontFamily }
  ...
  return (
    <footer style={{ padding: isMobile ? "32px 0 0" : "64px 0 0", background: "var(--deep-purple)", color: "rgba(255,255,255,0.7)", direction: dir, fontFamily }}>
...
// ─── VerticalNav (EN locked) ─────────────────────────────────────────────────
const DARK_SECTIONS = new Set(["exec-hero", "exec-fit", "exec-testi"])
...
function VerticalNav() {
  ...
  const sections = [
    { id: "exec-hero",     label: "Intro" },
    { id: "exec-problem",  label: "The Problem" },
    { id: "exec-timeline", label: "Journey" },
    { id: "exec-fit",      label: "Is It For You" },
    { id: "exec-score",    label: "LinkedIn Score" },
    { id: "exec-included", label: "What's Included" },
    { id: "exec-results",  label: "Results" },
    { id: "exec-testi",    label: "Testimonial" },
    { id: "exec-about",    label: "About" },
    { id: "faq",           label: "FAQ" },
        ...
        <div className="exec-hero__grid">
          <div className="exec-hero__text">
            <Reveal className="rv--blur">
              <span className="exec-hero__label"><LiIcon size={16} color="var(--lime)" /> LinkedIn for Executives</span>
            </Reveal>
              ...
              <div className="li-mockup">
                ...
                <div className="li-mockup__profile">
                  <div style={{ marginTop: 20 }}>
                    ...
                    <div style={{ fontSize: 12, color: "#666", marginTop: 2 }}>CEO & Co-Founder at YourCompany | B2B SaaS</div>
                    <div style={{ fontSize: 11, color: "#999", marginTop: 4, display: "flex", alignItems: "center", gap: 4 }}>
                      Tel Aviv, Israel · <span style={{ color: liBlue, fontWeight: 600 }}>500+ connections</span>
                    </div>
                  </div>
                ...
                <div className="li-mockup__analytics">
                  ...
                  <div style={{ display: "flex", gap: 20 }}>
                    {[
                      { val: phase >= 1 ? "2,847" : "14", label: "Profile views" },
                      { val: phase >= 1 ? "14,203" : "89", label: "Post impressions" },
                      { val: phase >= 1 ? "312" : "4", label: "Search appearances" },
                    ].map((stat, i) => (
                ...
                <div className={`li-mockup__popups ${phase >= 2 ? "show" : ""}`}>
                  {[
                    { bg: "#DFF0D8", icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="#2d7a2d"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z" /></svg>, title: "New DM from a VP of Sales", sub: '"Saw your post about..."', cls: "li-mockup__popup--1" },
                    { bg: "#E7F0FE", icon: <LiReaction type="like" size={16} />, title: '+47 reactions on your latest post', sub: "Including 3 C-level executives", cls: "li-mockup__popup--2" },
                    { bg: "#FFF3E0", icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="#E67E22"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" /></svg>, title: "Connection request accepted", sub: "CEO at a target account", cls: "li-mockup__popup--3" },
                  ].map((popup, i) => (
...
function ExecProblem() {
  const alts = EX.problem.alternatives?.en || []
  return (
    <ColorSection bg="var(--cream)" className="exec-problem" id="exec-problem">
      <div className="container">
        ...
        {EX.problem.pullquote?.en && (
          <Reveal delay={400}>
            <div className="pull-quote"><div className="pull-quote__bar" /><p>{EX.problem.pullquote.en}</p></div>
          </Reveal>
        )}
      </div>
    </ColorSection>
  ...
  return (
    <ColorSection bg="var(--deep-purple)" className="exec-fit" id="exec-fit">
      <div className="container">
        ...
        {EX.fit.honesty?.en && (
          <Reveal delay={400}><p className="fit-honesty">{EX.fit.honesty.en}</p></Reveal>
        )}
      </div>
    </ColorSection>
  )
...
function ExecTestimonial() {
  ...
  return (
    <ColorSection bg="var(--purple)" className="exec-testi" id="exec-testi">
      <div className="container">
        <Reveal className="rv--blur"><h2 className="sec-title sec-title--light">What a Client Says</h2></Reveal>
        ...
        <div className="about__layout">
          <Reveal className="rv--right">
            <div className="about__photo">
              <img src="https://raw.githubusercontent.com/Hanita-y/Octaloom-images-and-videos/main/HAN.png" alt="Hanita" className="about__photo-img" />
            </div>
          </Reveal>
...
function ExecFAQ() {
  ...
  const items = EX.faq.items.filter((it: any) => !it.heOnly)
  return (
...
function ExecBackLink() {
  return (
    <div style={{
      ...
      background: "var(--lime)", fontFamily: "var(--font-en)",
      ...
      <span>Not sure yet?{" "}
        <a href="https://www.octaloom.com/linkedin-growth-engine"
          ...
          Go back to all LinkedIn services
        </a>
      </span>
    </div>
  )
